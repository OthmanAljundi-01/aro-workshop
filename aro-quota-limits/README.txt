...
Please note that actual support for some of the above might vary depending on the OpenShift version or particular configurations of your cluster. Always refer to the OpenShift documentation for your specific version to get the most accurate and comprehensive list.
