...
MasterAddr="10.1.2.0/24"                # Master Subnet Address Prefixes

WorkerSubNet="$AROCluster-worker-subnet"   # Name of ARO Worker Subnet
WorkerAddr="10.1.3.0/24"                # Worker Subnet Address Prefixes
...
echo
echo The above Creation Time and Parameters can be used to file ARO Cluster Creation Failed
echo
echo
